...
class SegmentationNet10aTwoHead(VGGNet):
    def __init__(self, config):
        ...
        self.head_A = SegmentationNet10aHead(
            config,
            output_k=config.architecture.head_A_num_classes,
            cfg=SegmentationNet10a.cfg,
        )
        self.head_B = SegmentationNet10aHead(
            config,
            output_k=config.architecture.head_B_num_classes,
            cfg=SegmentationNet10a.cfg,
        )
